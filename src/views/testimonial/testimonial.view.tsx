...
import { TestimonialItemV1 } from '../../components/testimonial-item';
  ...
  return (
    <section className="ml-4 md:ml-[8%] mr-4 md:mr-0 mt-12 md:mt-40 mb-8 overflow-hidden bg-white ">
      <div className="flex flex-col mb-2 md:mb-16">
        <h4 className="w-full text-[26px] md:text-[42px] font-semibold underline">TESTIMONIAL</h4>
      </div>
      ...
      <div className="bg-white ">
        ...
        >
          {testimonials.map((testimonial, index) => (
            <TestimonialItemV1 key={index} {...testimonial} />
          ))}
        </Carousel>
      </div>
    </section>
