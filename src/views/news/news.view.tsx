  ...
  return (
    <section className="pl-[8%] mt-32 mb-12 overflow-hidden">
      <div className="flex flex-col">
        <h4 className="w-full mb-8 text-[42px] font-semibold underline">NEWS</h4>
      </div>
        ...
        >
          <div className="w-full grid grid-cols-12 gap-5">
            ...
            <div className="col-span-5 my-auto flex flex-col gap-4 justify-start items-start pr-10">
              <h4 className="text-[26px] text-left">Construction and Building</h4>
              <p className="text-justify">
                DQH Architects has an experienced construction team with a fully equipped 3000m2 production workshop
                that follows the latest technology trends. We are confident that our ability, responsibility, and
              ...
              <svg width="44" height="14" viewBox="0 0 44 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d="M0.5 6.5L42.5 6.5V7.5L0.5 7.5L0.5 6.5Z" fill="#303231" />
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
