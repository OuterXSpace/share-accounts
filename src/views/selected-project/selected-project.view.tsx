...
import { SelectedProjectSliderV1 } from '../../components';
  ...
  return (
    <section className="w-full mt-6 md:mt-20 2xl:mt-32 mb-12 px-4 md:pl-[8%] md:pr-[calc(8%-24px)]">
      <div className="flex flex-col">
        <h4 className="w-full mb-8 text-[26px] md:text-[42px] font-semibold underline">SELECTED PROJECTS</h4>
