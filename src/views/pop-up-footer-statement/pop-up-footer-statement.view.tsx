...
export const PopUpFooterStatement: React.FC<IPopUpFooterStatementProps> =
  observer((props) => {
    ...
    return (
      <animated.div
        style={{ height }}
        className="fixed bg-black bottom-0 left-0 w-full"
      >
        <div className="w-[95%] p-4 mx-auto my-auto flex justify-between flex-wrap items-center">
          <p className="w-[85%] text-white text-left">
            Chúng tôi sử dụng cookie để cung cấp cho bạn trải nghiệm tốt nhất
            trên trang chủ của chúng tôi. Bằng việc tiếp tục truy cập, bạn cho
            phép chúng tôi sử dụng cookie. Để tìm hiểu thêm vui lòng truy cập{" "}
            <span>
              <a
