...
const SelectedProjectSlider: React.FC = () => {
  return (
      ...
      <div className="w-full md:w-8/12 flex flex-wrap md:flex-col gap-4 pl-0.5 pr-0.5">
        ...
        <div className="flex flex-col gap-0">
          <span className="text-left">
            Investor: Zenta House - Mr. Chương - Ms. Nụ
          </span>
          <span className="text-left">
            Location: 69A Nguyễn Văn Trỗi, Ward 2, Bảo Lộc, Lâm Đồng
          </span>
          <span className="text-left">
            Facebook: www.facebook.com/zentahouse
          </span>
        </div>
        <ArrowRight />
      </div>
...
export default SelectedProjectSlider;
