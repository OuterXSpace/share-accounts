...
export const BriefIntro: React.FC<IBriefIntroProps> = () => {
  ...
  return (
    <div className="w-full flex flex-col px-4 md:px-[19.2%] mt-24 2xl:mt-80 md:mt-60">
      <h2 className="flex flex-wrap flex-row md:flex-col gap-2 md:gap-0 items-start justify-start font-semibold">
        <span className="text-[28px] lg:text-[48px] xl:text-[56px] 2xl:text-[64px] leading-tight">
          Architecture,
        </span>
        <span className="text-[28px] lg:text-[48px] xl:text-[56px] 2xl:text-[64px] leading-tight">
          Interior, and
      ...
      <div className="my-12 md:my-20 2xl:my-28 mr-8 md:mr-0">
        <p className="text-base 2xl:text-[26px] leading-6 2xl:leading-9">
          Incorporating a mix of youthful designers and seasoned engineers, we
          consistently infuse each product with originality, contemporary
          innovation, and careful attention to detail to ensure top-notch
          results.
        </p>
      </div>
    </div>
