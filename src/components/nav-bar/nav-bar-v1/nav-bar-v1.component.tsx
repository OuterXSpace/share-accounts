...
export const NavBarV1: React.FC<INavBarProps> = observer(({ initialWidth, initialPaddingRight, isHome = true }) => {
  ...
  const springProps = useSpring({
    paddingTop: isHome && widthScreen > 768 && scrollY < 700 ? 56 : widthScreen <= 768 ? 16 : 24,
    paddingBottom: isHome && widthScreen > 768 && scrollY < 700 ? 56 : widthScreen <= 768 ? 16 : 24,
  });
  ...
  return (
    <motion.div
      ...
      animate={{
        width: isHome ? (widthScreen > 768 && scrollY <= 700 ? '41.6666666667%' : '100%') : '100%',
      ...
      >
        ...
        <div className="flex flex-row-reverse md:flex-row items-center gap-6">
          <div
            ...
            onMouseEnter={() => api.start({ x1: 0, stroke: '#000000', strokeWidth: 1.7 })}
            onMouseLeave={() => api.start({ x1: 15, stroke: '#303231', strokeWidth: 1.5 })}
          >
            <animated.svg
              width="36"
              height="10"
