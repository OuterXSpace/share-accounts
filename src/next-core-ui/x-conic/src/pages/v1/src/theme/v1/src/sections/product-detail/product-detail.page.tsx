import { ProductDetailPageXConixTheme01Props } from './product-detail.type';
...
export const ProductDetailPageXConixTheme01: React.FC<ProductDetailPageXConixTheme01Props> = (props) => {
