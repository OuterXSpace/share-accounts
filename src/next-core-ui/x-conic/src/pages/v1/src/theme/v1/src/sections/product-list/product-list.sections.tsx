...
import { IProductListXConixTheme01Props } from './product-list.sections.type';
import { ProductCard } from '../../components/product-card';

export const ProductListXConixTheme01: React.FC<IProductListXConixTheme01Props> = (props) => {
