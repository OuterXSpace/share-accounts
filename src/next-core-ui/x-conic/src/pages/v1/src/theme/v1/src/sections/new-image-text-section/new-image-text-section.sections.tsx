...
import { INewImageTextSectionXConixTheme01Props } from './new-image-text-section.sections.type';

export const NewImageTextSectionXConixTheme01: React.FC<INewImageTextSectionXConixTheme01Props> = (props) => {
  const { data } = props;
