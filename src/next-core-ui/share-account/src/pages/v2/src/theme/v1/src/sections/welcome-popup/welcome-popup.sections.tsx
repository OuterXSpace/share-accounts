...
import { IWelcomePopupShareAccountTheme02Props } from './welcome-popup.sections.type';
import { Flowbite, Modal } from 'flowbite-react';
import { modalCustomTheme, AnnouncementComponent } from '../../../../../../../../../../../components';

export const WelcomePopupShareAccountTheme02: React.FC<IWelcomePopupShareAccountTheme02Props> = (props) => {
  const { data } = props;
