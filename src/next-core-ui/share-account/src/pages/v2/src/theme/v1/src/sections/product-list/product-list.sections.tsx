...
import { IProductListShareAccountTheme02Props } from './product-list.sections.type';
import { ProductCard } from '../../components/product-card';

export const ProductListShareAccountTheme02: React.FC<IProductListShareAccountTheme02Props> = (props) => {
