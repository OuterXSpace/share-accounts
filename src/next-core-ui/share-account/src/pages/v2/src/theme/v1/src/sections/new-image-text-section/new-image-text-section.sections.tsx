...
import { INewImageTextSectionShareAccountTheme02Props } from './new-image-text-section.sections.type';

export const NewImageTextSectionShareAccountTheme02: React.FC<INewImageTextSectionShareAccountTheme02Props> = (
  props,
) => {
  const { data } = props;
