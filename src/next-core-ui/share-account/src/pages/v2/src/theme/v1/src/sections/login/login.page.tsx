...
import { ILoginFormModel, ILoginPageShareAccountTheme02Props } from './login.type';
...
export const LoginPageShareAccountTheme02: React.FC<ILoginPageShareAccountTheme02Props> = () => {
