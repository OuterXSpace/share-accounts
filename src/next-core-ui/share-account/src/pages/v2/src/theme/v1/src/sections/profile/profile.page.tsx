...
import { IProfilePageShareAccountTheme02Props } from './profile.type';
...
export const ProfilePageShareAccountTheme02: React.FC<IProfilePageShareAccountTheme02Props> = (props) => {
  const { slugKey } = props;
