import { ProductDetailPageShareAccountTheme02Props } from './product-detail.type';
...
export const ProductDetailPageShareAccountTheme02: React.FC<ProductDetailPageShareAccountTheme02Props> = (props) => {
