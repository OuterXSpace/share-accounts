...
import { ISliderHomeShareAccountTheme02Props } from './slider-home.sections.type';
import Link from 'next/link';
import { SliderFull } from '../../components/slider-full';
import { SwiperSlide } from 'swiper/react';
import { LazyLoadImage } from 'react-lazy-load-image-component';

export const SliderHomeShareAccountTheme02: React.FC<ISliderHomeShareAccountTheme02Props> = (props) => {
  const { data } = props;
