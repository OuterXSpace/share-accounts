...
import { IDialogCartShareAccountTheme02Props } from './dialog-cart.type';
...
export const DialogCartShareAccountTheme02: React.FC<IDialogCartShareAccountTheme02Props> = (props) => {
