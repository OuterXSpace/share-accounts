...
import { IRegisterPageShareAccountTheme02Props } from './register.type';
...
export const RegisterPageShareAccountTheme02: React.FC<IRegisterPageShareAccountTheme02Props> = () => {
