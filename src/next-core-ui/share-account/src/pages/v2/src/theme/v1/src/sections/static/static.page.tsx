...
import { IStaticPageShareAccountTheme02Props } from './static.type';
import { Tab, TabPane } from './components';

export const StaticPageShareAccountTheme02: React.FC<IStaticPageShareAccountTheme02Props> = (props) => {
  const { data } = props;
