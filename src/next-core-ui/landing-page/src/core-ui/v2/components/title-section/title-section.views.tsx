...
export const TitleSection: React.FC<ITitleSectionProps> = (props) => {
  ...
  return (
    <div className="section half-margin">
      <div className="flex rounded-[50vw] border border-[0.8px] border-white uppercase justify-center px-[6vw] py-[2vw] md:px-[1vw] md:py-[1.2vw] lg:px-[0.8vw] lg:py-[0.3vw] gap-[0.7vw] items-center w-fit h-[1.8vw]">
