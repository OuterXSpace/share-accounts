...
export const PerspectivesGridSection: React.FC<IPerspectivesGridSectionProps> = (props) => {
  ...
  return (
    <div id="perspectives-grid" className="perspectives" x-data="{shareopen: null, inview1: false}">
      <div className="relative bleed-wrapper overflow-hidden">
        <div className="grid-wrapper lg:px-0">
          <div className="grid grid-flow-row grid-cols-4 lg:grid-cols-8 border-animate-horiz border-animate-base after:border-t after:top-0 border-animate-bleed-rtl inview">
            <div className="order-1 col-span-4 pt-10 pb-12 mb-8 lg:col-span-3 tex-wm-black lg:py-10 lg:pl-4 grid:pl-0 lg:px-8 lg:m-0 border-animate-base border-animate-vert after:top-0 lg:after:border-t-0 lg:after:border-r after:right-0 before:right-0 inview">
              <div className="relative h-full lg:flex lg:flex-col lg:justify-between lg:items-start lg:pr-4">
                ...
                <Link href="/perspectives" target="" className="type-button">
                  See all Perspectives
                </Link>
              </div>
            </div>
            <div className="order-4 col-span-4 pb-8 mb-8 lg:col-span-2 text-wm-black lg:py-10 lg:order-2 border-animate-horiz border-animate-base after:border-b after:bottom-0 after:left-0 lg:px-8 lg:m-0 inview">
              <div className="story-card relative group">
                ...
                >
                  <span
                    className="rounded-full absolute top-[-2px] right-0 group-hover:bg-wm-gradient-yellow flex items-center justify-center w-7 h-7"
                    role="presentation"
                  >
            ...
            <div className="order-2 col-span-4 pb-8 mb-8 lg:col-span-3 lg:row-span-2 lg:row-start-2 lg:order-4 lg:p-0 lg:m-0 border-animate-horiz border-animate-base after:border-b after:bottom-0 after:left-0 lg:after:border-0 inview">
            ...
            <div className="order-3 col-span-4 pb-8 mb-8 lg:col-span-3 text-wm-black lg:py-10 lg:row-start-3 lg:order-6 lg:px-8 lg:m-0 border-animate-horiz border-animate-vert border-animate-base after:border-b after:bottom-0 after:right-0 lg:after-right-auto lg:after:left-0 inview">
              <div className="story-card relative group">
                <Link
            ...
            <div className="order-7 col-span-4 pb-8 mb-8 lg:col-span-2 text-wm-black lg:py-10 lg:col-start-7 lg:row-start-2 lg:order-6 lg:relative lg:px-8 lg:m-0 border-animate-bleed-ltr border-animate-horiz border-animate-vert border-animate-base after:border-b lg:after:border-l lg:after:h-full after:bottom-0 after:right-0 lg:after:right-auto lg:after:left-0 inview">
              <div className="story-card relative group">
                <Link
