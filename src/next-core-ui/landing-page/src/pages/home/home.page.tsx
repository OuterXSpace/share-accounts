        ...
        <div className="ml-0 md:ml-24 p-8">
          ...
          <section id="about" className="my-16">
            ...
            <p className="text-gray-300">
              ...
              professional experience. My passion for capturing and creating compelling visual stories has driven me to
              develop a strong skill set in both video editing and videography. I am eager to bring my creative vision
              and technical expertise to new and exciting projects.
            </p>
